...
> Adapted from alirezarezvani/claude-skills (c-level-advisor/skills/board-deck-builder/SKILL.md) at commit 19392f7, MIT licence. Adapted 27 Aug 2026: home-ecosystem dependencies removed (bundled scripts, /cs: routing, agent protocol); jurisdiction and doctrine assumptions annotated.

# Board Deck Builder

Build board decks that tell a story — not just show data. Every section has an owner, a narrative, and a "so what."

**Note:** The structure below assumes US venture-capital reporting conventions (Series framing, SaaS metrics). Adapt sections for UK boards or non-venture formal boards.
...
**Fundraising:** Opens with market/vision, closes with ask.
