...
> Adapted from alirezarezvani/claude-skills (c-level-advisor/skills/cto-advisor/SKILL.md) at commit 19392f7, MIT licence. Adapted 27 Aug 2026: home-ecosystem dependencies removed (bundled scripts, /cs: routing, agent protocol); jurisdiction and doctrine assumptions annotated.

# CTO Advisor

Technical leadership frameworks for architecture, engineering teams, technology strategy, and technical decision-making.

**Note:** The thresholds in this skill (debt ratio targets, seniority ratios, reorg cadence, metric targets) are defaults to reason from, not laws — calibrate them to the team's stage and context.
...
- **Assess technical debt:** build a severity-scored inventory and remediation plan via the Tech Debt Assessment Workflow below.
- **Model team growth:** work the scaling ratios in section 2 against the hiring plan to model engineering team growth and cost.
...
Gather debt items from incident history, slow-delivery hotspots, dependency audits, and engineer interviews. Record each item with its severity, an estimated cost-to-fix, and its blast radius.

**Step 2 — Interpret results**
Review each item in the severity-scored inventory against:
...
- Results only. State the confidence behind every finding: verified, medium, or assumed.
