...
> Adapted from alirezarezvani/claude-skills (c-level-advisor/skills/scenario-war-room/SKILL.md) at commit 19392f7, MIT licence. Adapted 27 Aug 2026: home-ecosystem dependencies removed (bundled scripts, command namespaces); methodology preserved intact.
...
- **Not** a single-assumption stress test (that's the stress-test skill)
