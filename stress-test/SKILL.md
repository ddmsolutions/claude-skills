---
name: "stress-test"
description: "Business assumption stress testing. Use before betting on a plan whose core assumptions are unvalidated — e.g. stress-testing 'enterprise buyers will tolerate a 6-month pilot' or a hockey-stick revenue model."
---

> Adapted from alirezarezvani/claude-skills (c-level-advisor/executive-mentor/skills/stress-test/SKILL.md) at commit 19392f7, MIT licence. Adapted 27 Aug 2026: home-ecosystem dependencies removed (bundled scripts, command namespaces); methodology preserved intact.
