---
name: "postmortem"
description: "Honest analysis of what went wrong. Use after a failed launch, missed quarter, or bad hire to run a blameless 5-Whys retrospective with a change register — e.g. dissecting why the Q3 release slipped six weeks."
---

> Adapted from alirezarezvani/claude-skills (c-level-advisor/executive-mentor/skills/postmortem/SKILL.md) at commit 19392f7, MIT licence. Adapted 27 Aug 2026: home-ecosystem dependencies removed (bundled scripts, command namespaces); methodology preserved intact.
